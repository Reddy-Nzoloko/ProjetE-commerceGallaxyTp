      ...
      <div class="bg-white shadow-md rounded-2xl overflow-hidden hover:shadow-lg transition">
        ...
        <div class="p-4">
          ...
          <div class="flex justify-between items-center mt-4">
            <a href="panier.php?action=add&id=<?= $p['id_produit'] ?>" class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm transition">
              <i data-feather="shopping-cart" class="w-4 h-4"></i> Ajouter
            </a>
            <!-- ✅ Lien modifié vers valider_whatsapp_direct.php -->
            <a href="valider_whatsapp_direct.php?id=<?= $p['id_produit'] ?>"
               class="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg text-sm transition">
...
<section class="container mx-auto py-10 px-4">
  ...
  <div class="grid md:grid-cols-2 gap-6">
    <?php foreach($prods as $p): ?>
      <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition flex overflow-hidden">
        ...
        <div class="p-4 flex-1 flex flex-col justify-between">
          ...
          <div class="flex justify-end gap-2 mt-3">
            <a href="panier.php?action=add&id=<?= $p['id_produit'] ?>" class="bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-lg transition">
...
<footer class="bg-black text-white py-8 text-center">
  <div class="flex justify-center gap-6 text-xl mb-4">
    <a href="https://wa.me/243992261070" class="hover:text-green-400 transition"><i data-feather="message-circle"></i></a>
    <a href="https://www.instagram.com/reddynzoloko3" class="hover:text-pink-400 transition"><i data-feather="instagram"></i></a>
    <a href="http://www.facebook.com/share/1AKPxS8gTP/?mibextid=wwXlfr" class="hover:text-blue-500 transition"><i data-feather="facebook"></i></a>
    <a href="https://github.com/Reddy-Nzoloko" class="hover:text-gray-300 transition"><i data-feather="github"></i></a>
  </div>
  <p class="text-sm opacity-50">© RedDev 2025 Gallaxy Paint</p>
</footer>
